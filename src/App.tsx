  ...
  return (
    <div className="font-sans text-idf-dark bg-white min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-100 h-20 flex items-center">
        <div className="container mx-auto px-6 md:px-20 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <span className="font-serif font-bold text-xl tracking-tight uppercase">Indonesian Diaspora <span className="text-idf-red">Foundation</span></span>
          </div>
          <div className="flex items-center gap-8">
            ...
            <button className="bg-idf-red text-white px-8 py-3 rounded-none text-xs font-bold uppercase tracking-widest transition-all hover:bg-red-800 active:scale-95">
              Give Today
            </button>
          </div>
        </div>
      ...
      <header className="pt-40 pb-20 md:pt-48 md:pb-24">
        <div className="container mx-auto px-6 md:px-20 flex flex-col md:flex-row gap-20 items-start">
          <div className="w-full md:w-[60%]">
            ...
            >
              A child in Sumba deserves shoes, a roof, and a future.
            </motion.h1>
            <motion.p 
              {...fadeIn}
            ...
            >
              <button className="bg-idf-red text-white px-10 py-4 rounded-none text-sm font-bold uppercase tracking-widest transition-all hover:bg-red-800">
                Give Today
              </button>
      ...
      <section className="px-6 md:px-20 pb-32">
        ...
        >
          <img 
            src="https://picsum.photos/seed/sumba/1920/1080" 
            alt="Children in Sumba Island"
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-idf-dark/60 via-transparent to-transparent flex flex-col justify-end p-8 md:p-16">
            <h3 className="text-white font-serif text-3xl md:text-4xl mb-2">Sumba Island, East Nusa Tenggara</h3>
      ...
      <section id="mission" className="py-24 border-t border-slate-50">
        <div className="container mx-auto px-6 md:px-20">
          <div className="max-w-4xl">
            ...
            >
              <h2 className="text-4xl font-serif font-bold text-idf-dark">IDF</h2>
              
              <div className="space-y-8">
                <div>
                  <p className="text-xl text-idf-gray leading-relaxed">
                    <span className="font-bold text-idf-dark">Mission Statement:</span> The Indonesian Diaspora Foundation is dedicated to uniting Indonesians around the world and fostering a spirit of global humanity. We preserve our rich cultural heritage, provide vital resources to empower both diaspora members and citizens, and lead philanthropic initiatives that uplift vulnerable communities in Indonesia and beyond.
                  </p>
                </div>

                <div>
                  <p className="text-xl text-idf-gray leading-relaxed">
                    <span className="font-bold text-idf-dark">Vision:</span> Empowering a new generation of Indonesian to connect across borders, celebrate their roots, and lead global change through compassion, culture, and collaboration.
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-32 bg-white">
        <div className="container mx-auto px-6 md:px-20">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="p-12 md:p-20 border border-slate-100 max-w-5xl mx-auto text-center"
          >
            <p className="text-2xl md:text-4xl font-serif italic text-idf-dark mb-10 leading-relaxed">
            ...
            <p className="text-idf-red font-serif italic text-lg">— Indonesian Diaspora Foundation</p>
          </motion.div>
        </div>
      </section>
...
function CrisisPoint({ stat, title, desc }: { stat: string, title: string, desc: string }) {
  return (
    <motion.div variants={fadeIn}>
      <p className="text-idf-red text-5xl font-serif mb-6">{stat}</p>
      <h4 className="text-lg font-bold mb-4 uppercase tracking-wider">{title}</h4>
